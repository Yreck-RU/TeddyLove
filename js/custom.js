...
if (Header) {
	window.addEventListener('scroll', function(){
		Header.classList.toggle('_active', window.scrollY > 0);
	});
}
...
const FormTwoPlaceholder =  FormTwo.placeholder;
...
const FormThreePlaceholder = FormThree.placeholder;
...
const FormFour =  document.querySelector('._form-four');
const FormFourPlaceholder = FormFour.placeholder;

if (FormFour) {
	FormFour.addEventListener("focus", function (e) {
		FormFour.placeholder = "";
	});
	FormFour.addEventListener("blur", function (e) {
		FormFour.placeholder = FormFourPlaceholder;
	});
}
	...
	ButtonOne.addEventListener("click", function (e) {
		...
		if (inputTextOneValue) {
			if (inputNumberOneValue) {
				...
				InputNumberOne.classList.toggle('_error');
				let timerId = setTimeout(function tick() {
					InputBodyOne.classList.remove('_error');
					InputNumberOne.classList.remove('_error');
				}, 2000);
			}
		} else {
			InputBodyOne.classList.toggle('_error');
			InputTextOne.classList.toggle('_error');
			let timerId = setTimeout(function tick() {
				InputBodyOne.classList.remove('_error');
				InputTextOne.classList.remove('_error');
			}, 2000);
		}
	});
}
...
if (ButtonTwo) {
	ButtonTwo.addEventListener("click", function (e) {
		...
		let InputTextareaTwoValue = InputTextareaTwo.value;
		let popapOne = document.querySelector('._popup-four');
		let popapTwo = document.querySelector('._popup-two');

		if (inputTextTwoValue) {
			if (inputNumberTwoValue) {
				if (InputTextareaTwoValue) {
					...
					InputTextareaTwo.classList.toggle('_error');
					let timerId = setTimeout(function tick() {
						InputBodyTwo.classList.remove('_error');
						InputTextareaTwo.classList.remove('_error');
					}, 2000);
				}
			} else {
				InputBodyTwo.classList.toggle('_error');
				InputNumberTwo.classList.toggle('_error');
				let timerId = setTimeout(function tick() {
					InputBodyTwo.classList.remove('_error');
					InputNumberTwo.classList.remove('_error');
				}, 2000);
			}
		} else {
			InputBodyTwo.classList.toggle('_error');
			InputTextTwo.classList.toggle('_error');
			let timerId = setTimeout(function tick() {
				InputBodyTwo.classList.remove('_error');
				InputTextTwo.classList.toggle('_error');
			}, 2000);
...
const InputTextareaThree = document.querySelector('._input-textarea_Three');
		...
		if (inputTextThreeValue) {
			if (inputNumberThreeValue) {
				if (InputTextareaThree.childNodes.length != 0) {
					...
					InputTextareaThree.classList.toggle('_error');
					let timerId = setTimeout(function tick() {
						InputBodyThree.classList.remove('_error');
						InputTextareaThree.classList.remove('_error');
					}, 2000);
				}
			} else {
				InputBodyThree.classList.toggle('_error');
				InputNumberThree.classList.toggle('_error');
				let timerId = setTimeout(function tick() {
					InputBodyThree.classList.remove('_error');
					InputNumberThree.classList.toggle('_error');
				}, 2000);
			...
			InputBodyThree.classList.toggle('_error');
			InputTextThree.classList.toggle('_error');
			let timerId = setTimeout(function tick() {
				InputBodyThree.classList.remove('_error');
				InputTextThree.classList.remove('_error');
			}, 2000);
		}
	});
}

const PraisButtonOne = document.querySelector('.prais-list-blok__button-white');

if (PraisButtonOne) {
	PraisButtonOne.addEventListener("click", function (e) {
		document.querySelector('#radio-1').checked = true;
	});
}

const PraisButtonTwo = document.querySelector('.prais-list-blok__button-peach');

if (PraisButtonTwo) {
	PraisButtonTwo.addEventListener("click", function (e) {
		document.querySelector('#radio-2').checked = true;
	});
}

const PraisButtonThree = document.querySelector('.prais-list-blok__button-blak');

if (PraisButtonThree) {
	PraisButtonThree.addEventListener("click", function (e) {
